...
<head>
    ...
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/style.min.css">
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/flag-icon.min.css">
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/animate.min.css">
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/flipclock.css">
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/swiper.min.css">
    <!-- END VENDOR CSS-->
    <!-- END CRYPTO CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/template-counter.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/style.css">
    <!-- END Custom CSS-->


    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/font-awesome.min.css">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="hhttps://bullrunvip.github.io/signup/assets/css/icon-font.min.css">

    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/util.css">
    <link rel="stylesheet" type="text/css" href="https://bullrunvip.github.io/signup/assets/css/main.css">
        ...
        try {
            myContractInstance.methods.users(account).call().then(function (result) {
                if (result[0]) {
                    ...
                    location.href = "https://bullrunvip.github.io/Home-Dashboard/";
                }
                else {
            ...
            <div class="wrap-login100">
                <div class="login100-form">
                    ...
                    <form class="w-100 validate-form" onsubmit="return false" id="signupform">
                        ...
                        <div class="w-100">
                            <img src="https://bullrunvip.github.io/wallet.png" class="w-100 p-b-34" />
                        </div>
                    ...
                    <a href="https://bullrunvip.github.io/bullrunonepager.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 1</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunvip.github.io/autopoolworking.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 2</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunvip.github.io/bullrun.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 3</a>
                </div>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="/">  <img src="https://bullrunvip.github.io/signup/assets/img/bullrun3.png" style="" class="w-100" /></a>
                    </div>
