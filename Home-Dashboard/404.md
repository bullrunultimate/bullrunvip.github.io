...
<head>
    <script>
        ...
        if (account == null) {
            ...
            location.href = "https://bullrunvip.github.io/signin";
        }
    </script>
    <!-- Meta data -->
    <meta charset="UTF-8">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://bullrunvip.github.io/signup/assets/img/bullrun3.png">
    ...
    <!-- Bootstrap css -->
    <link href="https://bullrunvip.github.io/bootstrap.min.css" rel="stylesheet" />

    <!-- Style css -->
    <link href="https://bullrunvip.github.io/css.style.css" rel="stylesheet" />

    <!-- Default css -->
    <link href="https://bullrunvip.github.io/default.css" rel="stylesheet">

    <!-- Sidemenu css-->
    <link rel="stylesheet" href="https://bullrunvip.github.io/sidemenu.css">

    <!-- Bootstrap-daterangepicker css -->
    <link rel="stylesheet" href="https://bullrunvip.github.io/daterangepicker.css.html">

    <!-- Bootstrap-datepicker css -->
    <link rel="stylesheet" href="https://bullrun.live/Content/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.css">

    <!-- Custom scroll bar css -->
    <link href="https://bullrunvip.github.io/jquery.mCustomScrollbar.css" rel="stylesheet" />

    <!-- Sidemenu-repsonsive-tabs  css -->
    <link href="https://bullrunvip.github.io/sidemenu-responsive-tabs.css" rel="stylesheet">
            ...
            <div class="header-main header sticky">
                <div class="app-header header top-header navbar-collapse ">
                    <div class="container-fluid">
                        <div class="d-flex">
                            <a class="header-brand" href="https://bullrunvip.github.io/Home-Dashboard">
                    ...
                    <div class="first-sidemenu">
                        <div class="line-animations">
                            <ul class="resp-tabs-list hor_1">
                                ...
                                <li class="autopool"><a href="https://bullrunvip.github.io/Autopool"><span class="side-menu__icon"></span><img src="/m2.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Autopool"></a></li>
                                <li class="trans"><a href="https://bullrunvip.github.io/Transaction"><span class="side-menu__icon"></span><img src="/m3.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Transations"></a></li>
                                <li class="team2"><a href="https://bullrunvip.github.io/Team"><span class="side-menu__icon"></span><img src="/m4.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Team"></a></li>
                                <li class="media2"><a href="https://bullrunvip.github.io/Media"><span class="side-menu__icon"></span><img src="/m5.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Media"></a></li>
...
var address = "0x1fBe9723f1ac6a79c3D54Ca0E8C2288DEf60c69E";
var MyContract;
window.addEventListener('load', function () {
    if (typeof web3 !== 'undefined') {
        ...
        if (web3.currentProvider.isTrust) {
            ...
            const infura = 'https://mainnet.infura.io/v3/fdf6a5d496584d44bac26ae05f114503';
...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlink').html("https://bullrunvip.github.io/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').html("https://link.trustwallet.com/open_url?coin_id=60&url=https://bullrunvip.github.io/signup?referralid=" + result1.id);



            $('.currentuseridlink').val("https://bullrunvip.github.io/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').val("https://link.trustwallet.com/open_url?coin_id=60&url=https://bullrunvip.github.io/signup?referralid=" + result1.id);



            $('.sharebutton').attr('data-url', "https://bullrunvip.github.io/signup?referralid=" + result1.id);
...
var str = "";
//'0x1fBe9723f1ac6a79c3D54Ca0E8C2288DEf60c69E'
                ...
                <div class="banner banner-color mt-0">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 text-right d-flex d-block">
                        <div class="socialjs">
                            ...
                            <a class="sharebutton facebook btn " style="background-color:#3b5998;color:white" data-basecount="" data-sharetype="facebook" data-text="The page title" title="Share this on Facebook" href="#" data-url="https://bullrunvip.github.io/signup?referralid="><i class=" fa fa-facebook"></i></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6  mt-2 mb-2 p-l-10">
                        ...
                        <a href="https://etherscan.io/address/0x1fBe9723f1ac6a79c3D54Ca0E8C2288DEf60c69E" class="text-success" target="_blank">
                            0x1fBe9723f1ac6a79c3D54Ca0E8C2288DEf60c69E <i class="fa fa-external-link"></i>
                        </a>
                    </div>
                    <div class="col-md-6  mt-2 mb-2 text-center">
                        Copyright © 2020 <a href="#" class="fs-14 text-primary">https://bullrunvip.github.io</a>
                    </div>
                </div>
            </div>
        </footer>
